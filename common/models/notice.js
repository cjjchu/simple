...
module.exports = (Notice) => {
  ...
  Notice.disableRemoteMethod('findById', true);
  Notice.disableRemoteMethod('findOne', true);

  // disable count & exists
  Notice.disableRemoteMethod('confirm', true);
  Notice.disableRemoteMethod('count', true);
  Notice.disableRemoteMethod('exists', true);

  Notice.disableRemoteMethod('create', true);
  Notice.disableRemoteMethod('upsert', true);
  Notice.disableRemoteMethod('deleteById', true);
  Notice.disableRemoteMethod('updateAll', true);
  Notice.disableRemoteMethod('updateAttributes', false);
  Notice.disableRemoteMethod('createChangeStream', true);

  Notice.disableRemoteMethod('replaceById', true);
  Notice.disableRemoteMethod('replaceOrCreate', true);
  Notice.disableRemoteMethod('upsertWithWhere', true);

  Notice.disableRemoteMethod('__get__apar', false);
