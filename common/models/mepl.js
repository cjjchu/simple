...
module.exports = (Mepl) => {
  ...
  // Mepl.disableRemoteMethod('findById', true);
  Mepl.disableRemoteMethod('findOne', true);

  // disable count & exists
  Mepl.disableRemoteMethod('confirm', true);
  Mepl.disableRemoteMethod('count', true);
  Mepl.disableRemoteMethod('exists', true);

  Mepl.disableRemoteMethod('create', true);
  Mepl.disableRemoteMethod('upsert', true);
  Mepl.disableRemoteMethod('deleteById', true);
  Mepl.disableRemoteMethod('updateAll', true);
  Mepl.disableRemoteMethod('updateAttributes', false);
  Mepl.disableRemoteMethod('createChangeStream', true);

  Mepl.disableRemoteMethod('replaceById', true);
  Mepl.disableRemoteMethod('replaceOrCreate', true);
  Mepl.disableRemoteMethod('upsertWithWhere', true);

  // instance methods
  Mepl.disableRemoteMethod('__get__meplItems', false);
  Mepl.disableRemoteMethod('__count__meplItems', false);
  Mepl.disableRemoteMethod('__create__meplItems', false);
  Mepl.disableRemoteMethod('__delete__meplItems', false);
  Mepl.disableRemoteMethod('__destroyById__meplItems', false);
  Mepl.disableRemoteMethod('__findById__meplItems', false);
  Mepl.disableRemoteMethod('__updateById__meplItems', false);

  Mepl.disableRemoteMethod('__exists__meplItems', false);
  Mepl.disableRemoteMethod('__link__meplItems', false);
  Mepl.disableRemoteMethod('__unlink__meplItems', false);
