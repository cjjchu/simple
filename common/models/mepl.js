...
module.exports = (Mepl) => {
  ...
  Mepl.disableRemoteMethodByName('find', true);
  Mepl.disableRemoteMethodByName('findById', true);
  Mepl.disableRemoteMethodByName('findOne', true);

  // disable count & exists
  Mepl.disableRemoteMethodByName('confirm', true);
  Mepl.disableRemoteMethodByName('count', true);
  Mepl.disableRemoteMethodByName('exists', true);

  Mepl.disableRemoteMethodByName('create', true);
  Mepl.disableRemoteMethodByName('upsert', true);
  Mepl.disableRemoteMethodByName('deleteById');
  Mepl.disableRemoteMethodByName('updateAll', true);
  Mepl.disableRemoteMethodByName('updateAttributes', false);
  Mepl.disableRemoteMethodByName('createChangeStream', true);

  Mepl.disableRemoteMethodByName('replaceById', true);
  Mepl.disableRemoteMethodByName('replaceOrCreate', true);
  Mepl.disableRemoteMethodByName('upsertWithWhere', true);

  // instance methods
  // Mepl.disableRemoteMethodByName('__get__meplItems', false);
  // Mepl.disableRemoteMethodByName('__count__meplItems', false);
  // Mepl.disableRemoteMethodByName('__create__meplItems', false);
  // Mepl.disableRemoteMethodByName('__delete__meplItems', false);
  // Mepl.disableRemoteMethodByName('__destroyById__meplItems', false);
  // Mepl.disableRemoteMethodByName('__findById__meplItems', false);
  // Mepl.disableRemoteMethodByName('__updateById__meplItems', false);
  //
  // Mepl.disableRemoteMethodByName('__exists__meplItems', false);
  // Mepl.disableRemoteMethodByName('__link__meplItems', false);
  // Mepl.disableRemoteMethodByName('__unlink__meplItems', false);
  ...
  */
  ...
  Mepl.MeplForPmr_v1 = (pmrid, req, cb) => {
    console.log("==============\n"+pmrid);
